...
#### 3. Length (HARD ceiling 80 words)
   Static body per email is at most 80 words (prose + CTA, excluding the greeting, the AI-variable lines, and the signature). Over 80 = fail, except one value-stack email per sequence which may reach ~100 words as a numbered list of real numbers. Follow-ups target under 55.
